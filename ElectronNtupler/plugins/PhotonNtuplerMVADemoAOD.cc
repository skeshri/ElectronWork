...
// Class:      PhotonNtuplerMVADemoAOD
// 
/**\class PhotonNtuplerMVADemoAOD PhotonNtuplerMVADemoAOD.cc ElectronWork/ElectornNtupler/plugins/PhotonNtuplerMVADemoAOD.cc
...
// These includes below are needed for electron veto
...
class PhotonNtuplerMVADemoAOD : public edm::EDAnalyzer {
   public:
      explicit PhotonNtuplerMVADemoAOD(const edm::ParameterSet&);
      ~PhotonNtuplerMVADemoAOD();
   ...
   private:
      ...
      // Collection for computing electron veto
...
//
PhotonNtuplerMVADemoAOD::PhotonNtuplerMVADemoAOD(const edm::ParameterSet& iConfig):
  vtxToken_(consumes<reco::VertexCollection>(iConfig.getParameter<edm::InputTag>("vertices"))),
  photonCollectionToken_(consumes<edm::View<reco::Photon> >(iConfig.getParameter<edm::InputTag>("photons"))),
  electronCollectionToken_(consumes<reco::GsfElectronCollection >(iConfig.getParameter<edm::InputTag>("electrons"))),
  conversionsCollectionToken_(consumes<reco::ConversionCollection >(iConfig.getParameter<edm::InputTag>("conversions"))),
...
PhotonNtuplerMVADemoAOD::~PhotonNtuplerMVADemoAOD()
{
...
void
PhotonNtuplerMVADemoAOD::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace std;
  using namespace edm;
  ...
  iEvent.getByToken(electronCollectionToken_, hElectrons);

  // Get conversions collection
  edm::Handle< reco::ConversionCollection>  hConversions;
  iEvent.getByToken(conversionsCollectionToken_, hConversions);
  ...
  for( View<reco::Photon>::const_iterator pho = collection->begin();
    ...
    if( hConversions.isValid()){
      // taken from PATPhotonProducer.cc
      passelectronveto = !ConversionTools::hasMatchedPromptElectron(pho->superCluster(), 
								    hElectrons, hConversions, 
								    beamSpotHandle->position());
    }
    passElectronVeto_      .push_back( passelectronveto );
    ...
    varE1x3overE5x5_ = (*full5x5E1x3Map)[ phoPtr ] / (*full5x5E5x5Map)[ phoPtr ];
    varE2x2overE5x5_ = (*full5x5E2x2Map)[ phoPtr ] / (*full5x5E5x5Map)[ phoPtr ]; 
    varE2x5overE5x5_ = (*full5x5E2x5MaxMap)[ phoPtr ]/ (*full5x5E5x5Map)[ phoPtr ]; 
    ...
    isTrueAlternative_.push_back( matchToTruthAlternative(*pho, genParticles) );
...
void 
PhotonNtuplerMVADemoAOD::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
PhotonNtuplerMVADemoAOD::endJob() 
{
}
...
/*
void 
PhotonNtuplerMVADemoAOD::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
PhotonNtuplerMVADemoAOD::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
PhotonNtuplerMVADemoAOD::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
PhotonNtuplerMVADemoAOD::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
PhotonNtuplerMVADemoAOD::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
int PhotonNtuplerMVADemoAOD::matchToTruth(const reco::Photon &pho, 
...
void PhotonNtuplerMVADemoAOD::findFirstNonPhotonMother(const reco::Candidate *particle,
						int &ancestorPID, int &ancestorStatus){
  
  if( particle == 0 ){
    printf("PhotonNtuplerMVADemoAOD: ERROR! null candidate pointer, this should never happen\n");
    return;
  }
...
int PhotonNtuplerMVADemoAOD::matchToTruthAlternative(const reco::Photon &pho, 
						     const edm::Handle<edm::View<reco::GenParticle>>  
						     &genParticles)
{
...
DEFINE_FWK_MODULE(PhotonNtuplerMVADemoAOD);
