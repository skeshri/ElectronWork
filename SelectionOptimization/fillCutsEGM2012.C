...
void fillCutsEGM2012(){

  // Working points defined by EGM for 2012 cut-based electron ID

  // 
  // All barrel working points
  //

  TString fname_bveto = "cut_repository/cuts_barrel_EGM2012_WP_Veto.root";
  TFile *fout_bveto = new TFile(fname_bveto, "recreate");
  VarCut *varCut_bveto = new VarCut();
  varCut_bveto->setCutValue("full5x5_sigmaIetaIeta"   ,0.01 ); 
  varCut_bveto->setCutValue("dEtaIn"                  ,0.007); 
  varCut_bveto->setCutValue("dPhiIn"                  ,0.8  ); 
  varCut_bveto->setCutValue("hOverE"                  ,0.15 ); 
  varCut_bveto->setCutValue("relIsoWithDBeta"         ,0.15 ); 
  ...
  TString fname_bloose = "cut_repository/cuts_barrel_EGM2012_WP_Loose.root";
  TFile *fout_bloose = new TFile(fname_bloose, "recreate");
  VarCut *varCut_bloose = new VarCut();
  varCut_bloose->setCutValue("full5x5_sigmaIetaIeta"   ,0.01 ); 
  varCut_bloose->setCutValue("dEtaIn"                  ,0.007); 
  varCut_bloose->setCutValue("dPhiIn"                  ,0.15 ); 
  varCut_bloose->setCutValue("hOverE"                  ,0.12 ); 
  varCut_bloose->setCutValue("relIsoWithDBeta"         ,0.15 ); 
  ...
  TString fname_bmedium = "cut_repository/cuts_barrel_EGM2012_WP_Medium.root";
  ...
  varCut_bmedium->setCutValue("dEtaIn"                  ,0.004); 
  varCut_bmedium->setCutValue("dPhiIn"                  ,0.06 ); 
  varCut_bmedium->setCutValue("hOverE"                  ,0.12 ); 
  varCut_bmedium->setCutValue("relIsoWithDBeta"         ,0.15 ); 
  ...
  TString fname_btight = "cut_repository/cuts_barrel_EGM2012_WP_Tight.root";
  ...
  varCut_btight->setCutValue("dEtaIn"                  ,0.004); 
  varCut_btight->setCutValue("dPhiIn"                  ,0.03 ); 
  varCut_btight->setCutValue("hOverE"                  ,0.12 ); 
  varCut_btight->setCutValue("relIsoWithDBeta"         ,0.10 ); 
  ...
  TString fname_eveto = "cut_repository/cuts_endcap_EGM2012_WP_Veto.root";
  TFile *fout_eveto = new TFile(fname_eveto, "recreate");
  VarCut *varCut_eveto = new VarCut();
  varCut_eveto->setCutValue("full5x5_sigmaIetaIeta"   ,0.03 ); 
  varCut_eveto->setCutValue("dEtaIn"                  ,0.01 ); 
  varCut_eveto->setCutValue("dPhiIn"                  ,0.7  ); 
  varCut_eveto->setCutValue("hOverE"                  ,1e30 ); 
  varCut_eveto->setCutValue("relIsoWithDBeta"         ,0.15 ); 
  ...
  TString fname_eloose = "cut_repository/cuts_endcap_EGM2012_WP_Loose.root";
  TFile *fout_eloose = new TFile(fname_eloose, "recreate");
  VarCut *varCut_eloose = new VarCut();
  varCut_eloose->setCutValue("full5x5_sigmaIetaIeta"   ,0.03 ); 
  varCut_eloose->setCutValue("dEtaIn"                  ,0.009); 
  varCut_eloose->setCutValue("dPhiIn"                  ,0.1  ); 
  varCut_eloose->setCutValue("hOverE"                  ,0.10 ); 
  varCut_eloose->setCutValue("relIsoWithDBeta"         ,0.15 ); 
  ...
  TString fname_emedium = "cut_repository/cuts_endcap_EGM2012_WP_Medium.root";
  TFile *fout_emedium = new TFile(fname_emedium, "recreate");
  VarCut *varCut_emedium = new VarCut();
  varCut_emedium->setCutValue("full5x5_sigmaIetaIeta"   ,0.03 ); 
  varCut_emedium->setCutValue("dEtaIn"                  ,0.007); 
  varCut_emedium->setCutValue("dPhiIn"                  ,0.03 ); 
  varCut_emedium->setCutValue("hOverE"                  ,0.10 ); 
  varCut_emedium->setCutValue("relIsoWithDBeta"         ,0.15 ); 
  ...
  TString fname_etight = "cut_repository/cuts_endcap_EGM2012_WP_Tight.root";
  TFile *fout_etight = new TFile(fname_etight, "recreate");
  VarCut *varCut_etight = new VarCut();
  varCut_etight->setCutValue("full5x5_sigmaIetaIeta"   ,0.03 ); 
  varCut_etight->setCutValue("dEtaIn"                  ,0.005); 
  varCut_etight->setCutValue("dPhiIn"                  ,0.02 ); 
  varCut_etight->setCutValue("hOverE"                  ,0.10 ); 
  varCut_etight->setCutValue("relIsoWithDBeta"         ,0.10 ); 
